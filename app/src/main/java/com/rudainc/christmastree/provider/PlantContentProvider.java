...
import static com.rudainc.christmastree.provider.PlantContract.AUTHORITY;
...
public class PlantContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        // Add URI matches
        uriMatcher.addURI(AUTHORITY, PATH_PLANTS, PLANTS);
        uriMatcher.addURI(AUTHORITY, PATH_PLANTS + "/#", PLANT_WITH_ID);
        return uriMatcher;
    }
